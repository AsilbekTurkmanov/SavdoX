...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-uzum-bg font-sans flex flex-col justify-between text-uzum-text antialiased relative">
      {/* Header */}
      <Header
      ...
      <main className="flex-1 pb-20 sm:pb-16">
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 mt-4 sm:mt-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div>
              <h2 className="text-lg sm:text-2xl font-black text-uzum-text tracking-tight flex flex-wrap items-center gap-1.5 sm:space-x-2">
              ...
              <p className="text-[11px] sm:text-xs text-uzum-muted mt-0.5">
                Topilgan mahsulotlar soni: <strong className="text-uzum-primary font-bold">{sortedProducts.length} ta</strong>
              </p>
            </div>

            {/* Sorting controls */}
            <div className="flex items-center space-x-2 bg-white px-3 py-1.5 sm:py-2 rounded-2xl border border-gray-200/80 shadow-xs shrink-0 self-start sm:self-auto">
          ...
          {sortedProducts.length === 0 ? (
            <div className="bg-white rounded-3xl p-8 sm:p-12 text-center border border-gray-200 max-w-md mx-auto my-6 sm:my-8 space-y-3">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-purple-100 text-uzum-primary flex items-center justify-center mx-auto">
                <Sparkles className="w-7 h-7 sm:w-8 sm:h-8" />
              </div>
              <h3 className="text-base sm:text-lg font-bold text-uzum-text">Mahsulot topilmadi</h3>
